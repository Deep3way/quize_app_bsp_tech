...
extension StyledWidget on Widget {
    ...
    bool autoFocus = false,
      ...
      Builder(
        builder: (BuildContext context) {
          //  PERFORMANCE: findAncestorWidgetOfExactType vs InheritedWidget performance
  ...
  //  FEATURE: animate aspectRatio widget
  Widget aspectRatio({
  ...
  //  FEATURE: animate FractionallySizedBox
